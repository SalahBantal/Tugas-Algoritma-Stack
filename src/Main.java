...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        // seeder
        playlists.push(new Playlist("Rockabye", "CleanBandit"));
        playlists.push(new Playlist("We don't talk anymore", "Charlie Puth"));
        playlists.push(new Playlist("Vogel im Kafig", "Hiroyuki Sawano"));
        // end seeder
